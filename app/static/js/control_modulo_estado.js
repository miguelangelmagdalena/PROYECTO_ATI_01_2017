$(document).ready(function(){//Cuando cargan todos los elementos del DOM
    ...
    $("#Superbutton_load").click( function(){
...
function hide_button(){ // Elimina el botón de carga de mas publicaciones del DOM
	...
	var item = document.getElementById("Superbutton_load");
...
function hide_button2(){ // Elimina el botón de carga de mas publicaciones del DOM
...
function show_button2(index,increment,max_value){// Agrega de nuevo el botón de carga de mas publicaciones al final de las publicaciones
...
function more_elements_callback(index,increment,max_value){ //Funcion para agregar elementos mas despues del indice
	...
	if (max > max_value) {
		...
		//Agregamos el boton
		show_button2(max,increment,max_value);
	}
