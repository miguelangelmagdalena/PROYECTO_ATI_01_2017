    ...
    <div class="container-fluid">
    	<header class="header">
            ...
            <div class="header3" id="menu_header3">
                ...
                <a class="active" href="index.php"><button class="active dropbtn" >   INICIO</button></a>
    ...
    <div class="container-fluid">
    	...
    	<form  id="ajax_inicio">
    		...
    		<fieldset class="blue">
                ...
                <legend id="page1">Inicio:</legend>

                <table >
                    <tr>
                        <th>Correo:</th>
                        <th><input type="email" name="correo" required></th>
                        <th id="response_email"></th>
                    </tr>
                    <tr>
                        <th>Contraseña:</th>
                ...
                <input type="submit" value="Iniciar" ></th>
        ...
        <div id="response"> </div>
        <img id="loading2" src="imagenes/loading1.gif" alt="loading" height="42" width="42"> 
    </div>
